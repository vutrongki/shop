...
<div class="container">
    <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
        ...
        ?>
        <a href="{{ route('categories.detail', $product->categories->id)}}" class="stext-109 cl8 hov-cl1 trans-04">
            {{ Str::ucfirst($product->categories->name) }}
            <i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
        </a>
                ...
                <div class="p-l-25 p-r-30 p-lr-0-lg">
                    <div class="wrap-slick3 flex-sb flex-w">
                        ...
                        <div class="slick3 gallery-lb">
                            <div class="item-slick3" data-thumb="{{ $product->feature_image_path }}">
                                <div class="wrap-pic-w pos-relative">
                                    <img src="{{ $product->feature_image_path }}" alt="IMG-PRODUCT">

                                    <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{ $product->feature_image_path }}">
                    ...
                    <div class="p-t-33">
                            ...
                            <div class="size-204 respon6-next">
                                <div class="rs1-select2 bor8 bg0">
                                    <select class="js-select2" name="color">
                                        ...
                                        <option class='product-color' data-color="{{ $color->name }}" value="{{ $color->id }}">{{ $color->name }}</option>
                                        @endforeach
                                    </select>
                                    <div class="dropDownSelect2"></div>
                                </div>
                        ...
                        <div class="flex-w flex-r-m p-b-10">
                            <div class="size-204 flex-w flex-m respon6-next">
                                ...
                                <button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail" data-url="{{route('addToCart', $product->id)}}">
                                    Add to cart
                                </button>
                            </div>
                        </div>
                ...
                <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="{{ $relatedProduct->feature_image_path }}" alt="IMG-PRODUCT">
    ...
    $('.js-addcart-detail').each(function() {
        ...
        $(this).on('click', function() {
            ...
            console.log(quantity);
             var productColor = $('.product-color').data('color');
            let url = $(this).data('url') + '?color=' + productColor + '&quantity=' + quantity;
            console.log(url);
            $.ajax({
                type: 'GET',
                url: url,
